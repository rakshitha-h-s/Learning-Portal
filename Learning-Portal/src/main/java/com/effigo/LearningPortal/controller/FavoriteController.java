...
public class FavoriteController {
	...
	@PostMapping
	public FavoriteEntity saveFavoriteEntity(@RequestBody FavoriteEntity user) {
        //UserEntity createdUser = userService.saveUserEntity(user);
        return favService.saveFavoriteEntity(user);
    }

	@PutMapping
	public FavoriteEntity updateFavoriteEntity(@RequestBody FavoriteEntity userEntity) {
		return favService.updateFavoriteEntity(userEntity);
	}
