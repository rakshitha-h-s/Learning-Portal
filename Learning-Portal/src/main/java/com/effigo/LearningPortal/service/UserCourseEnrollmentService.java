...
public interface UserCourseEnrollmentService {
	...
	UserCourseEnrollmentEntity saveUserCourseEnrollmentEntity(UserCourseEnrollmentEntity usercourseenrollentity);
	UserCourseEnrollmentEntity updateUserCourseEnrollmentEntity(UserCourseEnrollmentEntity usercourseenrollentity);
