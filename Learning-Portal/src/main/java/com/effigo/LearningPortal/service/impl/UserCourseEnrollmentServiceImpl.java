...
public class UserCourseEnrollmentServiceImpl implements UserCourseEnrollmentService{
	...
	@Override
	public UserCourseEnrollmentEntity saveUserCourseEnrollmentEntity(
			UserCourseEnrollmentEntity usercourseenrollentity) {
		// TODO Auto-generated method stub
		return usercourseenrollmentRepository.save(usercourseenrollentity);
	}

	@Override
	public UserCourseEnrollmentEntity updateUserCourseEnrollmentEntity(
			UserCourseEnrollmentEntity usercourseenrollentity) {
		// TODO Auto-generated method stub
		return usercourseenrollmentRepository.save(usercourseenrollentity);
	}
